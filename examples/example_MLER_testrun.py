...
RAOdir      = os.path.join('data', 'RAO_data')
outputDir   = os.path.join('data', 'TestData')
Test.readRAO(3,os.path.join(RAOdir,'RAO_heave_RM3float.dat'))
Test.readRAO(5,os.path.join(RAOdir,'RAO_pitch_RM3float.dat'))
