...
Dependencies
-------------
`Python 2.7.x <https://www.python.org/downloads/>`_ and the following Python packages are required to run `WDRT`. `WDRT` currently will not run on Python 3.5.x.
...
Installation Process via GitHub
-------------------------------
